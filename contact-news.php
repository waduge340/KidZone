...
<div class="wrap col2">
<!------------Image------------>
<aside class="wxy" style="top: 25%;">
<img src="images/share_your_story.png">
</aside>
<aside class="xyz" style="top: 42%;">
...
<p>
<button class="btn btn-1 btn-1e" onClick="window.location.href='contact-news.php'" />News</button>
<button class="btn btn-1 btn-1e" onClick="window.location.href='contact-feed.php'">Feedback</button>
</p>
</section>
</div>
...
<h1><span class="log-in">Share What You Have</span></h1>
<p class="float">
...
<label>Upload Files</label>
	<input type="file" name="files[]" multiple/></p><br>
<div style="position:static;">
<input type="submit" name="news-submit" value="Submit" onClick="reload"/>
